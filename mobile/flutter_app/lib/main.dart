...
void callbackDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    // Background refresh task (Android only)
    // In a background isolate, avoid heavy UI work; network fetch subscription here if needed.
    // This demo leaves actual fetch to app runtime to avoid complexity.
...
void main() {
  ...
  // Initialize Workmanager for Android periodic tasks
